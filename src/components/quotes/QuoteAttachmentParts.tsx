...
/**
 * ============================================================================
 * 🔴 여기 있는 것은 **엑셀 전용 스위치 · 그 확인 창 · 목록의 딱지**다 (3b-1 · 3c-2 · 3d-0)
 * ============================================================================
 ...
 *
 * 🔴 2026-09-22(조각 3c-2)에 **목록의 딱지**(`QuoteFileBadges`)가 더해졌고, 2026-09-23
 * (조각 3d-0)에 딱지 셋이 다 찼다 — 견적서 목록이 줄마다 「엑셀 전용」 · 「결재 PDF」 ·
 * 「엑셀 없음」을 왼쪽 칸에 붙이려고 쓴다(components/quotes/QuoteListSlots.tsx 의
 * `renderFileBadges` 슬롯). 🔴 **A/S 와 같은 이름 · 같은 자리**에 두었다.
 *
